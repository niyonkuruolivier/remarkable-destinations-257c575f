...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Remarkable Destinations" },
      ...
      { property: "og:title", content: "About — Remarkable Destinations" },
  ...
  return (
    <div className="bg-background">
      <PageHero
        ...
        subtitle="Remarkable Destinations is an East African journey house headquartered in Kigali, designing private safaris that move at the pace of the land — and leave it better than we found it."
      ...
      <section className="mx-auto max-w-[1180px] px-6 py-24 md:py-32">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-7 space-y-6 text-[17px] leading-[1.8] text-foreground/80">
            <p>
              Remarkable Destinations began in 2014 with a single hand-drawn itinerary —
